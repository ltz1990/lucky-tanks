...
public class MsgCenter {
	...
	public static final String TYPE_JOIN_SUCCESS = "1";// 加入成功,传送游戏坐标
	public static final String TYPE_JOIN_FAILED = "2";// 加入失败
	public static final String TYPE_TANK_MOVE = "3";// 坦克移动
	public static final String TYPE_BULLET = "4";// 炮弹发射
	public static final String TYPE_CREATE_OTHER_TANK="5"; //创建其它坦克
